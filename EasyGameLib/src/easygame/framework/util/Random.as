package easygame.framework.util
{
	 ...
	 * @author Mason
	 * @version 1.0.0
	 * create-time Nov 12, 2013 3:28:01 PM
	 * description 提供多种随机数[静态方法类]
	 **/
	public final class Random
	{
		...
		/**
		 * 获取一个(-baseV, baseV)区间的数
		 * @param	baseV
		 * @return
		 */
		public static function between(baseV:Number):Number
		{
			return baseV * Math.random() * wave;
		}
		/**
		 ...
		 * @return
		 */
		public static function color(red:String = "0-255", green:String = "0-255", 
									 blue:String = "0-255"):uint
		{
		 ...
		 * @return
		 */	
		public static function transform(num:uint):String
		{
		 ...
		 * @return
		 */
		public static function explain(str:String,isCodeAt:Boolean = true):Array
		{
			var argAr:Array = new Array;
			var tmpAr:Array = str.split(",");
			var len:int = tmpAr.length;
